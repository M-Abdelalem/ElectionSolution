<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CandidateDelete.ascx.cs" Inherits="Election.AdminControl.CandidateDelete" %>
...
<div id="search"><asp:LinkButton ID="LinkButton1" CssClass="link"    ValidationGroup="btn1" runat="server">حذف</asp:LinkButton>
<asp:TextBox ID="txt_delete" CssClass="form-control1" placeholder="ادخل رقم المرشح" runat="server"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txt_delete" class="valstyle12" ValidationGroup="btn1" runat="server" ErrorMessage="ادخل رقم المرشح"></asp:RequiredFieldValidator>
