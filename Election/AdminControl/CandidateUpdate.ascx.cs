...
{
    public partial class CandidateUpdate : System.Web.UI.UserControl
    {
        ...
        {
            Session["CandidateNumber"] = Convert.ToInt32(txt_search.Text);
        }
        ...
        protected void ListView1_ItemUpdating(object sender, ListViewUpdateEventArgs e)
        {
            ...
            TextBox txt1 = (TextBox)ListView1.EditItem.FindControl("NumberTextBox");            if (fu4.HasFile)
            {
