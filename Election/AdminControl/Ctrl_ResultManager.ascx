...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Ctrl_ResultManager.ascx.cs" Inherits="Election.AdminControl.Ctrl_ResultManager" %>
...
<br /><br />
<asp:LinkButton ID="lb_showresult" Visible="false" cssClass="link1" runat="server" OnClick="lb_showresult_Click">عرض كل النتائج للمشاهد</asp:LinkButton>
<asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
<asp:Panel ID="Panel1" Visible="false" CssClass="pnlBackGround" runat="server">
<h3>هل تريدعرض النتيجة</h3>
...
<asp:ModalPopupExtender ID="ModalPopupExtender1" BackgroundCssClass="modalBackground"  runat="server" CancelControlID="btn_notok" PopupControlID="Panel1" TargetControlID="lb_showresult"></asp:ModalPopupExtender>
<asp:ListView ID="ListView1" runat="server" DataSourceID="Objs_Result">
...
<asp:ObjectDataSource ID="Objs_Result" runat="server" SelectMethod="SelectResult" TypeName="Election.Dal.Sort"></asp:ObjectDataSource>
