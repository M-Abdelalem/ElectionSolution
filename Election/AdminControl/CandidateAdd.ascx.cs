...
{
    public partial class CandidateAdd : System.Web.UI.UserControl
    {
        ...
        protected void ListView1_ItemInserting(object sender, ListViewInsertEventArgs e)
        {
            ...
            TextBox txt1 = (TextBox)ListView1.InsertItem.FindControl("NumberTextBox");
            if (fu3.HasFile)
            {
                string imagename = txt1.Text.ToString() + fu3.FileName.ToString();
                string extention = Path.GetExtension(fu3.PostedFile.FileName);
                fu3.PostedFile.SaveAs(Server.MapPath("~/Images/img_candidate/" + imagename + extention));
